...
export default function CabCard({ cab, shortestDistance, source, destination }) {
    ...
    return (
        <div className="md:min-w-[450px] flex-1 bg-amber-200/70 p-4 rounded-lg">
            ...
            <div className="flex justify-between items-end">
                ...
                <button className="bg-primary-btn rounded-md text-white h-9 px-2 font-medium hover:bg-[#199346] md:px-3" onClick={handleBooking}>Book Now</button>
