...
export default function ConfirmationCard({ onCancel, source, destination, cab_fare }) {
    ...
    return (
        <div className="flex fixed justify-center items-center top-0 bottom-0 left-0 right-0 bg-black/30">
            <form ref={form} className="flex-1 max-w-[420px] mx-5 bg-white rounded-lg drop-shadow-xl py-6 md:py-10 md:px-0">
                {!cabBooked &&
                    <div className="px-10">
                ...
                {cabBooked && <div className="flex flex-col items-center justify-center">
                    <p className="text-sm md:text-lg text-green-600 mt-4 text-center">Your cab has been booked successfully.<br></br>A confirmation mail has been sent to your email.</p>
